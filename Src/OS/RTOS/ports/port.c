...
{
	extern void tls_os_timer_init(void);

	/* Start the timer that generates the tick ISR. */
//	prvSetupTimerInterrupt();		//not call here :dave
	tls_os_timer_init(); 
...
void vApplicationStackOverflowHook( xTaskHandle *pxTask, signed char *pcTaskame )
{
	printf("\ntask[%d] stack over flow\n",*pcTaskame);
}
#endif
