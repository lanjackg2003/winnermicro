...
#define configCPU_CLOCK_HZ			( ( unsigned long ) 80000000 )	/* =12.0MHz xtal multiplied by 5 using the PLL. *///内部处理器执行频率
#define configTICK_RATE_HZ			( ( portTickType ) 100u )	//时间片中断的频率
