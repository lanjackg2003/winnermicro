...
#define TLS_EFUSE_HW_VER_OFFSET (0x4E)
#define TLS_EFUSE_HW_VER_SIZE (6)
...
/**********************************************************************************************************
* Description: 	This function is used to get HW VERSION.
*
...
/**********************************************************************************************************
* Description: 	This function is used to set hw version.
*
* Arguments  : 	hwver		6 byte
*
* Returns    : 	TLS_EFUSE_STATUS_OK		set success
