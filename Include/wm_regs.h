...
#define HR_PMU_WLAN_XAL                (HR_PMU_BASE_ADDR + 0x8)
#define HR_PMU_BG_LDO_AWAKE_TIME_CTRL  (HR_PMU_BASE_ADDR + 0xC)
#define HR_PMU_XTAL_AWAKE_TIME         (HR_PMU_BASE_ADDR + 0x10)
#define HR_PMU_PLL_RST_TIME            (HR_PMU_BASE_ADDR + 0x14)
...
#define HR_PMU_PLL_CTRL             (HR_PMU_BASE_ADDR + 0x44)
#define HR_PMU_BYPASS_CTRL          (HR_PMU_BASE_ADDR + 0x48)
#define HR_PMU_BOD_CTRL             (HR_PMU_BASE_ADDR + 0x4C)
...
#define CLK_RST_CTL_BBP         (1UL<<0)
#define CLK_RST_CTL_MAC         (1UL<<1)
#define CLK_RST_CTL_SEC         (1UL<<2)
/***************************************************************
 * 内存模块寄存器定义
 ***************************************************************/
