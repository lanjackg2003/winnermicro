...
* Arguments  : 	enable:1, disable: 0
* Returns    :    	None
**********************************************************************************************************/
void tls_wifi_set_listen_mode(u8 enable);

/**********************************************************************************************************
* Description: 	This function is used to get listen mode;
* Arguments  : 	
* Returns    :    	1:listen mode; 0:normal mode
**********************************************************************************************************/
...
/*************************************************************************** 
* Function: tls_wifi_connect_by_sssid_bssid 
*
* Description: This function is used to connect AP by both SSID  and BSSID.
*                   
* Input: ssid:    SSID  Name to connect
*		bssid:  BSSID to connect with SSID
*		pwd:  password to connect AP
*		  
* 
* Output: None 
...
#if TLS_CONFIG_APSTA
/*************************************************************************** 
* Function: 	tls_wifi_apsta_start 
*
* Description:  This function is used to connect AP and create AP.
* 
* Input:  		ssid:  SSID  Name to connect
*		  		pwd:  password to connect AP
*               apsta_ssid: SSID  Name for apsta's softap
* 
* Output: 		None 
* 	
* Return: 	
...
/*************************************************************************** 
* Function: tls_wifi_apsta_start_by_bssid 
*
* Description: This function is used to connect AP by BSSID and create AP.
* 
* Input:  bssid:  BSSID to connect
*		  pwd:  password to connect AP
*         apsta_ssid: SSID  Name for apsta's softap
* 
* Output: None 
...
/*************************************************************************** 
* Function: tls_wifi_apsta_start_by_ssid_bssid 
*
* Description: This function is used to connect AP by both SSID and BSSID and create AP.
*                    
* Input: ssid:  SSID  Name to connect
*		bssid:  BSSID to connect  with SSID
*		pwd:  password to connect AP
...
* Date : 2015-6-11 
*****************************************************************************/
int tls_wifi_apsta_start_by_ssid_bssid(u8 *ssid, u8 ssid_len,u8 *bssid, u8 *pwd, u8 pwd_len, u8 *apsta_ssid, u8 apsta_ssid_len);
...
#if TLS_CONFIG_APSTA
#define     WIFI_APSTA_STA_JOIN_SUCCESS     0x4
#define     WIFI_APSTA_AP_JOIN_SUCCESS      0x5
#endif
...
/**********************************************************************************************************
* Description: 	send oneshot data to other sta
* Arguments  : 	dst  NULL , send broadcast info
...
#if TLS_CONFIG_AP
/**********************************************************************************************************
* Description: 	get have authed sta list
* Arguments  : 	sta_num  authed's station number
                buf      address to store returned station list info
