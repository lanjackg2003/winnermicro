...
#define TLS_OS_UCOS                     	CFG_OFF/*UCOSII  need to modify wm_config.inc*/
#define TLS_OS_FREERTOS			CFG_ON	/*FreeRTOS need to modify wm_config.inc*/
...
#define TLS_CONFIG_CLOUD_KII                                 (CFG_OFF && TLS_CONFIG_SOCKET_STD)

/** WEB SERVER **/
#define TLS_CONFIG_WEB_SERVER                           CFG_OFF

/**IGMP**/
#define TLS_CONFIG_IGMP            				CFG_OFF

/** UPNP AND DLNA**/
#define TLS_CONFIG_UPNP                          CFG_OFF && TLS_CONFIG_SOCKET_STD&&TLS_CONFIG_IGMP
...
#define  TLS_CONFIG_APSTA                  (CFG_OFF && TLS_CONFIG_AP)
...
#define TLS_CONFIG_UDP_ONE_SHOT CFG_ON
#define TLS_CONFIG_UDP_JD_ONESHOT (CFG_ON&&TLS_CONFIG_UDP_ONE_SHOT)
#define TLS_CONFIG_UDP_LSD_ONESHOT (CFG_ON&&TLS_CONFIG_UDP_ONE_SHOT)

//AP ONESHOT
#define TLS_CONFIG_AP_MODE_ONESHOT (CFG_OFF&&TLS_CONFIG_AP)

//AIRKISS ONESHOT
#define TLS_CONFIG_AIRKISS_MODE_ONESHOT (CFG_OFF&&!TLS_CONFIG_UDP_ONE_SHOT)
